...
> **For interviewers (to save you time):** a ten slide visual walkthrough of the whole project — what it is, how the agent loop and context assembly work, the layered sandboxing, Google's OKF knowledge layer, and honest SWE-bench numbers. **[View the slide deck](https://drive.google.com/file/d/1yaqot8II9KR67eJBS2O_8WYeOmuj9QHm/view?usp=sharing)**
